...
import { Brain, Mail, Lock, Eye, EyeOff, User, AlertCircle, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Join Burnout Monitor</h1>
          <p className="text-gray-600">Create your account to start monitoring your wellness</p>
        </div>
              ...
              <div className="space-y-2">
                ...
                {formData.password && (
                  <div className="flex items-center space-x-2 text-sm">
                    <div className={`font-medium ${getPasswordStrengthLabel().color}`}>
                      ...
                      {[...Array(5)].map((_, i) => (
                        <div
                          ...
                          className={`h-1 w-4 rounded ${
                            i < getPasswordStrength() ? 'bg-current' : 'bg-gray-200'
