    ...
    <div className="space-y-6">
      ...
      <Card className="border-0 shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Share your thoughts and feelings. Our AI will analyze the sentiment
            to track your wellness.
          </CardDescription>
        </CardHeader>
          ...
          <div className="space-y-4">
            {recentEntries.length > 0 ? (
              ...
              <div className="text-center py-8 text-gray-500">
                ...
                <p>
                  No journal entries yet. Start writing to track your wellness!
                </p>
              </div>
            )}
          </div>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <p className="text-sm text-blue-700">
                {recentEntries.length > 1
                  ? `Your sentiment has ${
                      recentEntries[0].sentiment_score >
                      recentEntries[1].sentiment_score
                        ? "improved"
                        : "declined"
